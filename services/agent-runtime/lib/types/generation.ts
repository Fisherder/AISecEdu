...
export interface UserRequirements {
  ...
  /** 学科画像：'cybersecurity' 启用网安定制层（prompt 片段 + procedural-skill 门控）。 */
  subjectProfile?: 'cybersecurity';
  /** 培养方案中的课程编号或名称，用于加载课程上下文。 */
  courseId?: string;
}
...
export interface GeneratedSlideContent {
  ...
  /** Private, page-specific presenter script synchronized with the active slide. */
  speakerNotes?: string;
  /** Legacy presenter-note field retained for existing lessons and editors. */
  remark?: string;
  layout?: string;
