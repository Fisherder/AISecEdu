...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const body: GenerateClassroomInput = {
      ...
      ...(rawBody.subjectProfile ? { subjectProfile: rawBody.subjectProfile } : {}),
      ...(rawBody.courseId ? { courseId: rawBody.courseId } : {}),
      ...(rawBody.debate ? { debate: rawBody.debate } : {}),
      ...(rawBody.generatedAgentConfigs ? { generatedAgentConfigs: rawBody.generatedAgentConfigs } : {}),
    };
