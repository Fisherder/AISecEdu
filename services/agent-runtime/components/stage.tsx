...
export function Stage({
  ...
  /** Published/student playback can explicitly disable the Pro editor. */
  ...
  useEffect(() => {
    if (mode === 'edit' && (!isEditable || !allowEditMode)) {
      setMode('playback');
    }
  }, [allowEditMode, mode, isEditable, setMode]);
  ...
  const toggleHandler = isMaicEditorEnabled() && allowEditMode ? handleToggleEditMode : undefined;
