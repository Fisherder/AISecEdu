  ...
  return (
    ...
    >
      ...
      <div className="relative flex min-w-0 flex-1 items-center gap-3">
        <div
          aria-label="玄甲"
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-cyan-200/25 bg-cyan-100/[0.08] text-sm font-black text-cyan-100 shadow-[0_0_24px_rgba(34,211,238,0.18)]"
        >
          AI
        </div>
